...
class InsertDataSharpiMelk:
    ...
    def inser_data_sell(posts):
        ...
        param = (posts['token'], posts['phone'], posts['city'], posts['city_text'], 0, posts['mahal_text'], posts['types'], posts['title'], posts['price'], posts['meter'], posts['desck'], str(posts['map']), str(posts['LIST_DATA']))
...
class GetDataFull:
    ...
    def get_data(self):
        ...
        if x == 1:
            ...
            for (i,t) in self.Data_full.items():
                print(i)
